...
class WebUIStaticLayoutTests(WebUIStaticTestCase):
    ...
    def test_recent_reference_assets_are_rendered_and_submitted(self) -> None:
        ...
        self.assertIn('/static/app.js?v=runtime-346', html)
        self.assertIn('/static/styles.css?v=runtime-346', html)
    ...
    def test_api_source_switcher_and_system_settings_modal_exist(self) -> None:
        ...
        self.assertLess(html.index('id="systemSettingsCodexTab"'), html.index('id="systemSettingsStorageTab"'))
        self.assertLess(html.index('id="systemSettingsApiPanel"'), html.index('id="systemSettingsCodexPanel"'))
        self.assertLess(html.index('id="systemSettingsCodexPanel"'), html.index('id="systemSettingsStoragePanel"'))
