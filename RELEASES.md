...
当前正式版本：[v0.1.3](https://github.com/kadevin/ilab-gpt-conjure/releases/tag/v0.1.3)

## 版本说明

当前版本：`v0.1.3`。这个版本提供 Windows x64、macOS Apple Silicon、macOS Intel 三种免安装一键包；下载对应平台的 zip 后解压即可启动本地 WebUI。
